...
export const CARD_PRESETS: CardPreset[] = [
  {
    ...
    defaults: {
      ...
      backgroundValue: 'linear-gradient(135deg, #0f172a 0%, #1d4ed8 100%)',
      platform: 'wechat',
  ...
  },
  {
    ...
    defaults: {
      ...
      backgroundType: 'preset',
      backgroundValue: 'linear-gradient(135deg, #312e81 0%, #7c3aed 100%)',
  ...
  },
  {
    ...
    defaults: {
      ...
      theme: 'ocean-blue',
      backgroundType: 'preset',
      backgroundValue: 'linear-gradient(135deg, #0f766e 0%, #14b8a6 100%)',
      platform: 'twitter',

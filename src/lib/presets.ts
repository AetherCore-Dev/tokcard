...
export const CARD_PRESETS: CardPreset[] = [
  ...
  },
  {
    ...
    name: '微信可信介绍款',
    nameEn: 'WeChat Trust Intro',
    description: '适合微信 / 熟人传播，语气更稳，强调项目和可信度。',
    descriptionEn: 'Best for WeChat sharing with a calmer, trust-first tone.',
    emoji: '◉',
    accent: '#0f766e',
    preview: 'linear-gradient(135deg, #ecfeff 0%, #ccfbf1 45%, #a7f3d0 100%)',
    previewTone: 'light',
    platform: 'wechat',
    defaults: {
      channel: 'claude',
      theme: 'brand-light',
      backgroundType: 'preset',
      backgroundValue: 'linear-gradient(135deg, #ecfeff 0%, #ccfbf1 45%, #a7f3d0 100%)',
      platform: 'wechat',
      metaphorCategory: 'worker',
      avatarType: 'emoji',
      avatarValue: '🪪',
  ...
  {
    id: 'moments-flex-card',
    name: '朋友圈战绩款',
    nameEn: 'Moments Flex Card',
    description: '适合朋友圈晒战绩，数字冲击力更强。',
    descriptionEn: 'Made for Moments with a louder token flex.',
    emoji: '🔥',
    accent: '#f97316',
    preview: 'linear-gradient(135deg, #1f2937 0%, #7c2d12 45%, #fb923c 100%)',
    previewTone: 'dark',
    platform: 'wechat',
    defaults: {
      channel: 'claude',
      theme: 'brand-dark',
      backgroundType: 'preset',
      backgroundValue: 'linear-gradient(135deg, #1f2937 0%, #7c2d12 45%, #fb923c 100%)',
      platform: 'wechat',
      metaphorCategory: 'flex',
      avatarType: 'emoji',
      avatarValue: '🔥',
